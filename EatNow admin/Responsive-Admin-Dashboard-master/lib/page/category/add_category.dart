...
class UploadCategoryForm extends StatefulWidget {
  static const routeName = '/UploadProductForm';

  const UploadCategoryForm({Key? key}) : super(key: key);

  @override
  _UploadProductFormState createState() => _UploadProductFormState();
}

class _UploadProductFormState extends State<UploadCategoryForm> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const SizedBox(height: 25),
            Text('Uploaded Products', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
            const SizedBox(height: 10),
            ListView.builder(
              shrinkWrap: true,
